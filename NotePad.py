...
claer_all_icon = tk.PhotoImage(file = 'icons2/clear_all.png')
...
# edit.add_command(label='Clear All' , image = claer_all_icon , compound=tk.LEFT , accelerator='Ctrl+Alt+X')
...
file.add_command(label= "Open" , image=open_icon , compound=tk.LEFT , accelerator= 'Ctrl+O' , command=oepn_file)
...
def find_func(event = None):
    ...
    replace_input.grid(row = 0 , column=0 , padx=4 , pady =4 )
...
edit.add_command(label='Clear All' , image = claer_all_icon , compound=tk.LEFT , accelerator='Ctrl+Alt+X' , command=lambda:text_editor.delete(1.0 , tk.END))
